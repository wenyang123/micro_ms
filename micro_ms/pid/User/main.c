...
//							break;
						case ir_c_start:
						  ...
						  ir_adc_1c_value_sysc_get = ir_adc_1c_value_new;
        			ir_adc_2c_value_sysc_get = ir_adc_2c_value_new;
							break;
						default:
...
//					break;
				...
				case update_command:
					...
					if( ir_adc_1c_value_sysc_get > ir_value_lr) 
						led_s1_on;
					else
						led_s1_off;
					if(ir_adc_2c_value_sysc_get > ir_value_lr)  
						led_s2_on;
					else
						led_s2_off;
